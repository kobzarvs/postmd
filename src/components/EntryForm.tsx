  ...
  return (
    <form onSubmit={handleFormSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="customUrl" className="block font-medium text-gray-700 mb-1">
          ...
          />
          {errors.customUrl && (
            <p className="text-red-500 mt-1">{errors.customUrl.message}</p>
          )}
        </div>

        <div>
          <label htmlFor="editCode" className="block font-medium text-gray-700 mb-1">
          ...
          />
          {errors.editCode && (
            <p className="text-red-500 mt-1">{errors.editCode.message}</p>
          )}
        </div>
      </div>
